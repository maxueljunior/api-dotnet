...
public class AutenticacaoService : IAutenticacaoService
{
    ...
    public async Task<string> Login(UsuarioLogin usuarioLogin)
    {
        ...
        var response = await _httpClient.PostAsync("https://localhost:7209/api/identidade/autenticar", loginContent);
    ...
    public async Task<string> Registro(UsuarioRegistro usuarioRegistro)
    {
        ...
        var response = await _httpClient.PostAsync("https://localhost:7209/api/identidade/nova-conta", registroContent);
